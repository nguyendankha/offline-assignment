...
import zalora.utilities.ExcelDataReader;
import zalora.utilities.ExcelReader;
...
public class Page {
	...
	public static String excelTestDataPath = (workspaceDir + "\\src\\test\\resources\\excelData\\TestData.xlsx");
	public static ExcelReader excel = new ExcelReader(excelTestDataPath);
	...
	public static void sendEnterKey(By by) {
